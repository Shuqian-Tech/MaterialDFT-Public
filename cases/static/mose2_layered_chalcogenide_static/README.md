# mose2_layered_chalcogenide_static

mose2 layered chalcogenide static calculation，使用当前公开 binary 以 `NP=32` 运行并记录结果。

## 输入

- workflow：static
- 元素：Mo, Se
- KPOINTS：Gamma-centered / Gamma style `2 2 1`
...
```bash
cd cases/static/mose2_layered_chalcogenide_static
