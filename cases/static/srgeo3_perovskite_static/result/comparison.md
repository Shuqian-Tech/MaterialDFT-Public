...
| --- | --- | ---: | ---: | --- | ---: |
| MaterialDFT | 正常完成 | 1 | 13 | `13` | `3.695 s` |
| VASP 6.5.1 | 正常完成 | 1 | 13 | `13` | `3.594 s` |

## SCF 收敛判据

| 程序 | EDIFF | 最后 `DAV/RMM` 的 `|d eps|` | 判定 |
| --- | ---: | ---: | --- |
| MaterialDFT | `1.000e-05` | `3.567e-07` | 收敛 |
| VASP 6.5.1 | `1.000e-05` | `3.559e-07` | 收敛 |
...
```text
   1 F= -.31705540E+02 E0= -.31700653E+02  d E =-.977345E-02
```
