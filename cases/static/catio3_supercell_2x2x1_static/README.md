# catio3_supercell_2x2x1_static

catio3 supercell 2x2x1 static calculation，使用当前公开 binary 以 `NP=32` 运行并记录结果。

## 输入

- workflow：static
- 元素：Ca, Ti, O
- KPOINTS：Gamma-centered / Gamma style `1 1 1`
...
```bash
cd cases/static/catio3_supercell_2x2x1_static
