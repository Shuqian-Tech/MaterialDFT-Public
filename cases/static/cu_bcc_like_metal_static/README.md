# cu_bcc_like_metal_static

cu bcc like metal static calculation，使用当前公开 binary 以 `NP=32` 运行并记录结果。

## 输入

- workflow：static
- 元素：Cu
- KPOINTS：Gamma-centered / Gamma style `3 3 3`
...
```bash
cd cases/static/cu_bcc_like_metal_static
