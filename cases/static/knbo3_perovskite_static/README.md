...
```bash
cd cases/static/knbo3_perovskite_static
POTCAR=/path/to/knbo3_perovskite_static/POTCAR ./run.sh
```

如需使用较少 MPI ranks：

```bash
NP=4 POTCAR=/path/to/knbo3_perovskite_static/POTCAR ./run.sh
```
