# alo_centered_monoclinic_static

Al-O C-centered monoclinic static calculation，使用当前公开 binary 以 `NP=32` 运行并记录结果。
...
```bash
cd cases/static/alo_centered_monoclinic_static
