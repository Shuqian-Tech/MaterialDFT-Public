# graphene_vacuum_relax

Graphene vacuum-cell relaxation boundary calculation，使用当前公开 binary 以 `NP=32` 运行并记录结果。

## 输入

- workflow：relaxation
- 元素：C
- KPOINTS：Monkhorst-Pack `4 4 1`
...
```bash
cd cases/relax/graphene_vacuum_relax
