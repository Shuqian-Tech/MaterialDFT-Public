# gan_wurtzite_symbreak_isif3_relax

GaN symmetry-broken wurtzite ISIF=3 relaxation calculation，使用当前公开 binary 以 `NP=32` 运行并记录结果。
...
```bash
cd cases/relax/gan_wurtzite_symbreak_isif3_relax
