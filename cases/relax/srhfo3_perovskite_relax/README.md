...
```bash
cd cases/relax/srhfo3_perovskite_relax
POTCAR=/path/to/srhfo3_perovskite_relax/POTCAR ./run.sh
```

如需使用较少 MPI ranks：

```bash
NP=4 POTCAR=/path/to/srhfo3_perovskite_relax/POTCAR ./run.sh
```
