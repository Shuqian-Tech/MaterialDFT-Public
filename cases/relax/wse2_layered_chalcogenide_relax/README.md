# wse2_layered_chalcogenide_relax

wse2 layered chalcogenide relax calculation，使用当前公开 binary 以 `NP=32` 运行并记录结果。
...
```bash
cd cases/relax/wse2_layered_chalcogenide_relax
