...
```bash
cd cases/relax/v_scf_challenging_relax
POTCAR=/path/to/v_scf_challenging_relax/POTCAR ./run.sh
```

如需使用较少 MPI ranks：

```bash
NP=4 POTCAR=/path/to/v_scf_challenging_relax/POTCAR ./run.sh
```
