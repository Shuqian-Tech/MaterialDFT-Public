...
| --- | --- | ---: | ---: | --- | ---: |
| MaterialDFT | 正常完成 | 1 | 12 | `12` | `7.449 s` |
| VASP 6.5.1 | 正常完成 | 1 | 12 | `12` | `5.475 s` |

## SCF 收敛判据

| 程序 | EDIFF | 最后 `DAV/RMM` 的 `|d eps|` | 判定 |
| --- | ---: | ---: | --- |
| MaterialDFT | `1.000e-05` | `1.771e-06` | 收敛 |
| VASP 6.5.1 | `1.000e-05` | `1.740e-06` | 收敛 |
...
```text
   1 F= -.28834892E+02 E0= -.28825412E+02  d E =-.288349E+02
```
