# ge_defect_vacancy_small_relax_02

ge defect vacancy small relax 02 calculation，使用当前公开 binary 以 `NP=32` 运行并记录结果。
...
```bash
cd cases/relax/ge_defect_vacancy_small_relax_02
