...
```bash
cd cases/relax/rh_metal_defect_relax
POTCAR=/path/to/rh_metal_defect_relax/POTCAR ./run.sh
```

如需使用较少 MPI ranks：

```bash
NP=4 POTCAR=/path/to/rh_metal_defect_relax/POTCAR ./run.sh
```
