...
```bash
cd cases/relax/mo_metal_defect_relax
POTCAR=/path/to/mo_metal_defect_relax/POTCAR ./run.sh
```

如需使用较少 MPI ranks：

```bash
NP=4 POTCAR=/path/to/mo_metal_defect_relax/POTCAR ./run.sh
```
