# fe_defect_interstitial_small_relax_02

fe defect interstitial small relax 02 calculation，使用当前公开 binary 以 `NP=32` 运行并记录结果。
...
```bash
cd cases/relax/fe_defect_interstitial_small_relax_02
