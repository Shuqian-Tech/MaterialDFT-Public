...
| --- | --- | ---: | ---: | --- | ---: |
| MaterialDFT | 正常完成 | 1 | 12 | `12` | `4.275 s` |
| VASP 6.5.1 | 正常完成 | 1 | 12 | `12` | `3.746 s` |

## SCF 收敛判据

| 程序 | EDIFF | 最后 `DAV/RMM` 的 `|d eps|` | 判定 |
| --- | ---: | ---: | --- |
| MaterialDFT | `1.000e-05` | `8.467e-07` | 收敛 |
| VASP 6.5.1 | `1.000e-05` | `8.561e-07` | 收敛 |
...
```text
   1 F= -.12493420E+02 E0= -.12493420E+02  d E =-.124934E+02
```
