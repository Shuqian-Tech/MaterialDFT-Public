...
```bash
cd cases/relax/cr_early_metal_relax
POTCAR=/path/to/cr_early_metal_relax/POTCAR ./run.sh
```

如需使用较少 MPI ranks：

```bash
NP=4 POTCAR=/path/to/cr_early_metal_relax/POTCAR ./run.sh
```
